...
namespace WebCompilerTest.Config
{
    ...
    public class ConfigHandlerTest
    {
        ...
        private const string originalConfigFile = "../../../../WebCompilerTest/artifacts/config/originalcoffeeconfig.json";
        private const string processingConfigFile = "../../../../WebCompilerTest/artifacts/config/coffeeconfig.json";
