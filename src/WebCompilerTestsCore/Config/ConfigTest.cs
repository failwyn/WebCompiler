...
namespace WebCompilerTest.Config
{
    ...
    public class ConfigTest
    {
        ...
        private const string dummyConfigFile = "../../../../WebCompilerTest/artifacts/config/dummy.json";
        private const string inputFile = "../../../../WebCompilerTest/artifacts/config/compilationrequired.scss";
        private const string outputFile = "../../../../WebCompilerTest/artifacts/config/compilationrequired.css";
        private const string firstLevelDependencyFile = "../../../../WebCompilerTest/artifacts/config/dependencies/foo.scss";
        private const string secondLevelDependencyFile = "../../../../WebCompilerTest/artifacts/config/dependencies/sub/bar.scss";
